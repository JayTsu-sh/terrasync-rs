...
LAB_HDFS_LOCATION="${LAB_HDFS_LOCATION:-hdfs://hdfs%2Fterrasync-runner%40HDFS.LOCAL@hdfs-ha/}"
LAB_HDFS_ADMIN_USER="${LAB_HDFS_ADMIN_USER:-hdfs/terrasync-runner@HDFS.LOCAL}"
